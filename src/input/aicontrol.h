...
public:
    ...
    bool keyState(Controll c){return Vpressed[c];}    

    //Mutators:
    void virtual_press(Controll c){Vpressed[c] = true;} //Virtually Press key
    void virtual_unpress(Controll c){Vpressed[c] = false;} //Virtually unpress key
    void virtual_tap(Controll c){Vpressed[c] = true; Vtapped[c] = true;} 
    ...
    virtual void setKey(Controll c, int garbage){}
};
#endif //AICONTROL_H
